<?php /* Smarty version 2.6.13, created on 2014-09-04 13:30:22
         compiled from application/web/apps/listnews.html */ ?>
<!-- ki -->
<div class="page_section" id="project-page">
    <div id="container">
        <div class="titlebox">
            <h2 class="fl"><span class="icon-books">&nbsp;</span> News Shinkenjuku Default Dynamic Contect</h2>
...
public_assets/news/<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['img']; ?>
...
','mywindowtitle','width=1000,height=800,scrollbars=yes')" class="button"> <span class="icon-user4">Selengkapnya</a>
			...
			<div id="paging_of_news_lists" class="paging">
...
,"paging_of_news_lists","paging_ajax_newss",10);
