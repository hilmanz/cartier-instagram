<?php /* Smarty version 2.6.13, created on 2014-09-02 17:07:32
         compiled from application/admin/apps/listsystemshin.html */ ?>
<div class="page_section" id="project-page">
    <div id="container">
        <div class="titlebox">
            <h2 class="fl"><span class="icon-users">&nbsp;</span> System Background</h2>
     
        </div><!-- end .titlebox -->
        <div class="content">
        	<div class="summary">
       		 <p>Manage News that are allowed to access and use the CMS. You could also assign security roles to each System.</p>
            </div><!-- end .summary -->
...
systemshin/contentview?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_system']; ?>
','mywindowtitle','width=1000,height=800,scrollbars=yes')" 
 class="button"> <span class="icon-user4">View System</a>


						
                        	<a href="<?php echo $this->_tpl_vars['basedomain']; ?>
systemshin/editsystemshin?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_system']; ?>
...
systemshin/deletesystemshin?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_system']; ?>
