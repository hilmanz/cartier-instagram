<?php /* Smarty version 2.6.13, created on 2014-09-02 17:07:21
         compiled from application/admin/apps/listnews.html */ ?>
<div class="page_section" id="project-page">
    <div id="container">
        <div class="titlebox">
            <h2 class="fl"><span class="icon-users">&nbsp;</span> News Background</h2>
               <h2 class="fr"><a href="<?php echo $this->_tpl_vars['basedomain']; ?>
news/addnews" class="button2">Add New</a></h2>
        </div><!-- end .titlebox -->
        <div class="content">
        	<div class="summary">
...
news/contentview?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_news']; ?>
','mywindowtitle','width=1000,height=800,scrollbars=yes')" 
 class="button"> <span class="icon-user4">View News</a>


						
                        	<a href="<?php echo $this->_tpl_vars['basedomain']; ?>
news/editnews?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_news']; ?>
...
news/deletenews?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_news']; ?>
