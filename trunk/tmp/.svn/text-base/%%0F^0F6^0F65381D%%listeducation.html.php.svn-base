<?php /* Smarty version 2.6.13, created on 2014-09-02 17:07:16
         compiled from application/admin/apps/listeducation.html */ ?>
<div class="page_section" id="project-page">
    <div id="container">
        <div class="titlebox">
            <h2 class="fl"><span class="icon-users">&nbsp;</span> Education Background</h2>
               <h2 class="fr"><a href="<?php echo $this->_tpl_vars['basedomain']; ?>
home/addeducation" class="button2">Add New</a></h2>
        </div><!-- end .titlebox -->
        <div class="content">
        	<div class="summary">
       		 <p>Manage Education that are allowed to access and use the CMS. You could also assign security roles to each Education.</p>
            </div><!-- end .summary -->
...
home/contentview?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_education']; ?>
','mywindowtitle','width=1000,height=800,scrollbars=yes')" 
							class="button"> <span class="icon-user4">View Education</a>
                        	<a href="<?php echo $this->_tpl_vars['basedomain']; ?>
home/editeducation?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_education']; ?>
...
home/deleteeducation?id=<?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['id_education']; ?>
...
,"paging_of_user_list","paging_ajax_regis",10);
