<?php /* Smarty version 2.6.13, created on 2014-09-02 15:21:49
         compiled from application/admin/apps/edit_system.html */ ?>
<?php echo '
	<script>
...
../public_html/public_assets/systemshin/<?php echo $this->_tpl_vars['load']['img']; ?>
">
