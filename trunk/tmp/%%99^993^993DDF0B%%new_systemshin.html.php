<?php /* Smarty version 2.6.13, created on 2014-09-01 11:54:56
         compiled from application/admin/apps/new_systemshin.html */ ?>
<?php echo '
	<script>
...
<div class="page_section" id="project-page">
    <div id="container">
        <div class="titlebox">
            <h2 class="fl"><span class="icon-books">&nbsp;</span> Add New System</h2>
            <h2 class="fr"><a href="<?php echo $this->_tpl_vars['basedomain']; ?>
projects" class="button2">Back</a></h2>
        </div><!-- end .titlebox -->
        <div class="content">
            <div class="summary">
                <p>Shinkenjuku Management System helps you to overview all your System. Add your new System to start. </p>
            </div><!-- end .summary -->
