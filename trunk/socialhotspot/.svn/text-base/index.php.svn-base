...
if(preg_match('/(alcatel|amoi|android|avantgo|blackberry|benq|cell|cricket|docomo|elaine|htc|iemobile|iphone|ipad|ipaq|ipod|j2me|java|midp|mini|mmp|mobi|motorola|nec-|nokia|palm|panasonic|philips|phone|playbook|sagem|sharp|sie-|silk|smartphone|sony|symbian|t-mobile|telus|up\.browser|up\.link|vodafone|wap|webos|wireless|xda|xoom|zte)/i', $_SERVER['HTTP_USER_AGENT']))
	{
		echo '<img src="http://knspot.net/images/login/potrait/'.$bground['potrait'].'" id="bg" alt="">';
	
	}
else
	{
		echo '<img src="http://knspot.net/images/login/landscape/'.$bground['landscape'].'" id="bg" alt="">'; 
...
<div id="fb-root"></div>
	<div id="body">
		...
		<div  id="logo"  >
				...
				?>
						<a href="#" id="btnLoginTwitter"> <img src="images/btn_loginTwitter.png" /> </a>
				<?php
					}
				?>
       </div><!-- end #logo -->
...
FB.init({
// appId: '687862134568198',
appId: <?php echo $rs->fb_id; ?>,
status: true,
cookie: true,
xfbml: true,
oauth: true});
...
?>	
		...
		$.ajax({
			...
			{ 			
				...
				{
					$('#btnLoginTwitter').attr('href',response.urlConnect);
				}
