...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/cartier-instagram/trunk/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/cartier-instagram/trunk/";
	$PUBLIC_HTML = "public_html/";
}
$CONFIG['BASE_DOMAIN_PATH'] = "http://localhost/cartier-instagram/trunk/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "C:/xampp/htdocs/cartier-instagram/trunk/public_html/public_assets/";

$CONFIG['LOCAL_ASSET'] = "C:/xampp/htdocs/cartier-instagram/trunk/public_html/assets/";
...
$CONFIG['SESSION_NAME'] = "cartier-instagram-2014_apps_2014";
...
$CONFIG['DATABASE_WEB'] = "cartier-instagram";
